...
def establecerParametros():
    ...
    #Escogemos una muestra de las n ecuaciones 
    #Vector aleatorio de 0 y 1
    aleatorio = np.random.randint(2, size=(1,necuaciones))
    
    #Número de ecuaciones de la muestra. Lo usaremos en el desencriptado para calcular el rango en el que se encuentre Desc
